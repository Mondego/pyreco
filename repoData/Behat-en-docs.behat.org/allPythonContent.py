...
# -*- coding: utf-8 -*-
#
# Behat documentation build configuration file, created by
# sphinx-quickstart on Tue Feb 15 02:29:36 2011.
#
...
latex_documents = [
  ('index', 'Behat.tex', u'Behat Documentation',
   u'Konstantin Kudryashov (everzet)', 'manual'),
]
...
man_pages = [
    ('index', 'behat', u'Behat Documentation',
     [u'Konstantin Kudryashov (everzet)'], 1)
]
