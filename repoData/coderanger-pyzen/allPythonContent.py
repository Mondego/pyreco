...
# -*- coding: utf-8 -*-
#
# PyZen documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PyZen.tex', u'PyZen Documentation',
...
man_pages = [
    ('index', 'pyzen', u'PyZen Documentation',
     [u'Noah Kantrowitz'], 1)
]
