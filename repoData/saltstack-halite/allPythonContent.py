...
########NEW FILE########
__FILENAME__ = halite_functional_tests
# -*- coding: utf-8 -*-
...
########NEW FILE########
__FILENAME__ = test_server_start
if __name__ == "__main__":
    '''
