...
# -*- coding: utf-8 -*-
#
# django-uploadify documentation build configuration file, created by
...
project = u'django-uploadify'
copyright = u'2011, T. Stone, Nolan Brubaker'
...
htmlhelp_basename = 'django-uploadifydoc'
...
latex_documents = [
  ('index', 'django-uploadify.tex', u'django-uploadify Documentation',
   u'T. Stone, Nolan Brubaker', 'manual'),
]
...
man_pages = [
    ('index', 'django-uploadify', u'django-uploadify Documentation',
     [u'T. Stone, Nolan Brubaker'], 1)
]
...
texinfo_documents = [
  ('index', 'django-uploadify', u'django-uploadify Documentation', u'T. Stone, Nolan Brubaker',
   'django-uploadify', 'One line description of project.', 'Miscellaneous'),
]
