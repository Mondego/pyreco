...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','mattapp.statusbar.js')
	...
	f = os.path.join(cwd,'Classes','MattappStatusbarModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','mattapp.statusbar.js']
