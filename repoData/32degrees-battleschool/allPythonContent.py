...
########NEW FILE########
__FILENAME__ = battleschool_callback
...
########NEW FILE########
__FILENAME__ = ansible_module_dynamic
#This is documentation for when you write an ansible module in python

MODULE_ARGS = "time='March 14 12:23'"
MODULE_LANG = 'C'
MODULE_COMPLEX_ARGS = '{}'
