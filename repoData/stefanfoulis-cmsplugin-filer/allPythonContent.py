...
########NEW FILE########
__FILENAME__ = 0002_auto__add_field_filerfile_target_blank
# -*- coding: utf-8 -*-
import datetime
from south.db import db
...
########NEW FILE########
__FILENAME__ = 0009_auto__add_field_filerimage_use_original_image
# -*- coding: utf-8 -*-
import datetime
from south.db import db
from south.v2 import SchemaMigration
...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'cms.cmsplugin': {
            'Meta': {'object_name': 'CMSPlugin'},
            'changed_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
    ...
    complete_apps = ['cmsplugin_filer_image']
########NEW FILE########
__FILENAME__ = 0010_auto__add_field_filerimage_target_blank
# -*- coding: utf-8 -*-
import datetime
from south.db import db
from south.v2 import SchemaMigration
...
########NEW FILE########
__FILENAME__ = 0002_auto__chg_field_filerlinkplugin_file
# -*- coding: utf-8 -*-
import datetime
from south.db import db
from south.v2 import SchemaMigration
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilerLinkPlugin.file'
        db.alter_column('cmsplugin_filerlinkplugin', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FilerLinkPlugin.file'
        raise RuntimeError("Cannot reverse this migration. 'FilerLinkPlugin.file' and its values cannot be restored.")
...
########NEW FILE########
__FILENAME__ = cmsplugin_filer_js_tmp
# -*- coding: utf-8 -*-
