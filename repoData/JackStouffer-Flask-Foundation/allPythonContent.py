...
project = u'Flask Foundation'
copyright = u'2013, Jack Stouffer'
...
latex_documents = [
    ('index', 'flask-foundation.tex', u'Flask Foundation Documentation',
     u'Jack Stouffer', 'manual'),
]
...
man_pages = [
    ('index', 'Flask Foundation', u'Flask Foundation Documentation',
     [u'Jack Stouffer'], 1)
]
...
texinfo_documents = [
    ('index', 'Flask Foundation', u'Flask Foundation Documentation',
     u'Jack Stouffer', 'Flask Foundation', 'A solid foundation for flask',
     'Miscellaneous'),
]
