...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','dk.napp.testflight.js')
	...
	f = os.path.join(cwd,'Classes','DkNappTestflightModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','dk.napp.testflight.js']
