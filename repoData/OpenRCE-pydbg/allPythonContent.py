...
########NEW FILE########
__FILENAME__ = hardware_breakpoint
#
# PyDBG
# Copyright (C) 2006 Pedram Amini <pedram.amini@gmail.com>
#
...
class hardware_breakpoint:
    ...
    def __init__ (self, address=None, length=0, condition="", description="", restore=True, slot=None, handler=None):
        ...
        self.handler     = handler
########NEW FILE########
__FILENAME__ = memory_breakpoint
#
# PyDBG
# Copyright (C) 2006 Pedram Amini <pedram.amini@gmail.com>
#
...
########NEW FILE########
__FILENAME__ = memory_snapshot_block
#
# PyDBG
# Copyright (C) 2006 Pedram Amini <pedram.amini@gmail.com>
#
...
########NEW FILE########
__FILENAME__ = memory_snapshot_context
#
# PyDBG
# Copyright (C) 2006 Pedram Amini <pedram.amini@gmail.com>
#
