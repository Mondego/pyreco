...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','de.marcelpociot.social.js')
	...
	f = os.path.join(cwd,'Classes','DeMarcelpociotSocialModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','de.marcelpociot.social.js']
