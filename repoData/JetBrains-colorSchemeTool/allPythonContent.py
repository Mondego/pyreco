...
oc_block_comment = Attribute("OC.BLOCK_COMMENT", block_comment)
oc_line_comment = Attribute("OC.LINE_COMMENT", line_comment)
oc_cpp_keyword = Attribute("OC.CPP_KEYWORD", keyword)
oc_conditionally_not_compiled = Attribute("CONDITIONALLY_NOT_COMPILED", block_comment)
