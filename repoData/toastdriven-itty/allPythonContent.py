__FILENAME__ = alternate_servers
from itty import *
...
########NEW FILE########
__FILENAME__ = auto_environ_access
from itty import *
...
########NEW FILE########
__FILENAME__ = detail_on_exceptions
from itty import *
...
########NEW FILE########
__FILENAME__ = http_cookie_support
# -*- coding: utf-8 *-*
from itty import *
...
########NEW FILE########
__FILENAME__ = http_header_support
# -*- coding: utf-8 -*-
from itty import *
...
########NEW FILE########
__FILENAME__ = http_secure_cookie_support
# -*- coding: utf-8 *-*
from itty import *
...
########NEW FILE########
__FILENAME__ = run_under_modwsgi
from itty import *
...
########NEW FILE########
__FILENAME__ = sample_conf
# itty Config
host = 'localhost'
port = 8080
server = 'wsgiref'
########NEW FILE########
__FILENAME__ = sending_json_or_xml
