...
# -*- coding: utf-8 -*-
#
# Postgres Guide documentation build configuration file, created by
...
project = u'Postgres Guide'
copyright = u'2012, Craig Kerstiens'
...
html_sidebars = {
    'index':    ['sidebarintro.html', 
                 'searchbox.html'],
    '**':       ['localtoc.html', 'relations.html','sidebardetail.html',
                  'searchbox.html']
}
...
htmlhelp_basename = 'PostgresGuidedoc'
...
latex_documents = [
  ('index', 'PostgresGuide.tex', u'Postgres Guide',
   u'Craig Kerstiens', 'manual'),
]
...
man_pages = [
    ('index', 'postgresguide', u'Postgres Guide',
     [u'Craig Kerstiens'], 1)
]
...
texinfo_documents = [
  ('index', 'PostgresGuide', u'Postgres Guide   ',
   u'Craig Kerstiens', 'PostgresGuide', 'One line description of project.',
   'Miscellaneous'),
]
