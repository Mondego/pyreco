...
########NEW FILE########
__FILENAME__ = my_program
import networkx as nx
print "imported networkx"

########NEW FILE########
__FILENAME__ = module_IV
#!/usr/bin/env python
# encoding: utf-8
"""
module_IV.py
...
########NEW FILE########
__FILENAME__ = degree_centrality
import networkx as nx
...
########NEW FILE########
__FILENAME__ = degree_centrality1
import networkx as nx
...
########NEW FILE########
__FILENAME__ = degree_centrality2
import networkx as nx
...
########NEW FILE########
__FILENAME__ = degree_centrality3
def degree_centrality(G):
...
########NEW FILE########
__FILENAME__ = degree_centrality4
def degree_centrality(G):
...
########NEW FILE########
__FILENAME__ = degree_centrality5
def degree_centrality(G):
...
########NEW FILE########
__FILENAME__ = nx_degree_centrality
def degree_centrality(G):
